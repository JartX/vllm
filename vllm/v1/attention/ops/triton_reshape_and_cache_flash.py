...
def triton_reshape_and_cache_flash(
    ...
    is_int8_per_tensor = kv_cache_dtype in ("int8", "int8_per_tensor")
    if is_int8_per_tensor:
    ...
    if not is_int8_per_tensor and key_cache.dtype != kv_cache_torch_dtype \
    ...
    FP8_KV_CACHE = is_quantized_kv_cache(kv_cache_dtype) and not is_int8_per_tensor
