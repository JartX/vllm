...
The :func:`_reshape_cache_int4_kernel` quantizes K/V per (token, head),
packs two int4 nibbles per byte, and is invoked through the shared Python
launcher :func:`_run_reshape_kernel`.
"""
