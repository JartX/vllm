...
def kernel_unified_attention(
    ...
    for j in range(loop_lo, loop_hi):
        ...
        if USE_PER_TOKEN_HEAD_SCALES:
            # Fuse v per-(token, head) scale into P before the dot.
...
def unified_attention(
    ...
    # Upper-bound on the number of q-blocks; see commit history for the
    # full derivation.  Avoids realizing query lens on the CPU.
