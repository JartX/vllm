            ...
            for layer_name in group.layer_names:
                ...
                if isinstance(kv_cache_spec, AttentionSpec):
                    ...
                    if kv_cache_spec.kv_quant_mode.is_per_token:
                        ...
                        # The allocation respects the backend-defined
                        # stride order to ensure the semantic remains
                        # consistent for each backend. We first obtain
                        # the generic kv cache shape and then permute it
                        # according to the stride order which could
