...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Host-staged AllReduce for 2x RX 7900 XTX (no P2P, RCCL-free). Off by default.
    "VLLM_HOSTAR": lambda: bool(int(os.getenv("VLLM_HOSTAR", "0"))),
    "VLLM_HOSTAR_LIB": lambda: os.getenv("VLLM_HOSTAR_LIB", ""),
