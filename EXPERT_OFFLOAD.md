...
Branch: `feat/w4a16_expert_cache` (off `perf/rdna3_full_stack`).
...
### 3. Eager reference — `fused_moe/expert_cache.py`

`ExpertCache`: a host-driven LFRU reference implementation (correctness gate /
unit tests). Not on the serving path.
